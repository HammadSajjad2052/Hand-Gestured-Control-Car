...
VIDEOS=[("VIDEO_1","VID_2.mp4",0.05,0.3),
        ("VIDEO_2","RoboCar control using Hand Gestures 2023-05-13 14-06-06.mp4",0.05,0.35)]
...
#--------------------- ## Selection of Starting Video as a Default ## -------------------------------------------# 
